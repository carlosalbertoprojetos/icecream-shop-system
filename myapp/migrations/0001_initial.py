    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entregador', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, to='myapp.entregador')),
                ('forma_pagamento', models.ForeignKey(null=True, on_delete=django.db.models.deletion.RESTRICT, to='myapp.formapagamento')),
